...
console.log("🔍 Testing ENV:", process.env.NEXT_PUBLIC_CONVEX_URL);
...
const PDFDownloadLink = dynamic(
  () => import("@react-pdf/renderer").then((mod) => mod.PDFDownloadLink),
  {
    ...
    loading: () => (
      <Button disabled>
        <Loader2 className="animate-spin mr-2 h-4 w-4" /> Preparando...
      </Button>
    ),
  },
);
...
export default function ProjectPage() {
  ...
  const [selectedVuln, setSelectedVuln] =
    useState<Doc<"vulnerabilities"> | null>(null);
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-zinc-100 flex items-center gap-2">
            ...
            <Badge
              variant="outline"
              className="text-zinc-500 font-mono text-xs hidden sm:inline-flex"
            >
              {projectId.slice(-6)}
            </Badge>
          </h1>
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent className="bg-zinc-900 border-zinc-800 text-zinc-100">
            <DialogHeader>
              <DialogTitle>Reportar Vulnerabilidad</DialogTitle>
            </DialogHeader>
      ...
      <Tabs defaultValue="vulnerabilities" className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <Card className="bg-zinc-900 border-zinc-800">
              <CardHeader className="pb-2">
                <CardTitle className="text-sm text-zinc-400">Altas</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-zinc-900 border-zinc-800">
              <CardHeader className="pb-2">
                <CardTitle className="text-sm text-zinc-400">Medias</CardTitle>
              </CardHeader>
              <CardContent>
                      ...
                      {filteredFindings.map((vuln) => (
                        ...
                        >
                          <td className="py-3 px-4">
                            <Badge
                              variant="outline"
                              className={`${getSeverityColor(vuln.severity)} capitalize`}
                            >
                              {vuln.severity}
                            </Badge>
                          </td>
                          ...
                          <td className="py-3 px-4">
                            <Badge
                              variant="secondary"
                              className="bg-zinc-800 text-zinc-400 capitalize"
                            >
                              {vuln.status}
                            </Badge>
                          </td>
        ...
        <TabsContent value="report">
          <Card className="bg-zinc-900 border-zinc-800">
            <CardHeader>
              ...
              <CardDescription>
                Genera un PDF profesional con los {stats.total} hallazgos
                actuales.
              </CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col items-center justify-center py-12 space-y-6">
              ...
              <div className="text-center max-w-md space-y-2">
                ...
                <p className="text-zinc-400 text-sm">
                  El reporte incluirá una portada con el nombre{" "}
                  <strong>"{project.name}"</strong>, el resumen ejecutivo y el
                  detalle técnico.
                </p>
              </div>
                ...
                <PDFDownloadLink
                  document={
                    <PdfReport
                      ...
                      findings={findings}
                      // ACÁ le pasás la variable. Next.js la lee mejor desde las Pages/Components
